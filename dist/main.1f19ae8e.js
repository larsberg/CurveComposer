...
function () {
  ...
  _createClass(Curve, [{
    ...
    value: function sample(u) {
      ...
      var cp = this.points; // return first or last values when on the edges.
...
var _default = {
  ...
  methods: {
    getPath: function getPath() {
      ...
      for (var i = 0; i <= w; i += 1) {
        p += "".concat(i / w, " ").concat(this.curve.sample(i / w), " ");
      }
...
exports.default = _default;
        var $fc2010 = exports.default || module.exports;
      
      if (typeof $fc2010 === 'function') {
        $fc2010 = $fc2010.options;
      }
    
        /* template */
        Object.assign($fc2010, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$fc2010', $fc2010);
          } else {
            api.reload('$fc2010', $fc2010);
          }
        }
