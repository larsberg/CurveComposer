...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // Curve.js
  ...
  _createClass(Curve, [{
    ...
    value: function sample(u) {
      ...
      if (cp[cp.length - 1][1] <= u) {
        ...
        sample = (0, _Utils.lerp)(a[0], b[0], _eases2.default[a[2]](t));
      }
...
},{"./Composer/Utils":"Ah8Q","./Composer/Curve":"z1Ec","./Composer/eases":"kKuJ"}],"NK8i":[function(require,module,exports) {
'use strict';
...
},{"./Curve":"z1Ec"}],"osjH":[function(require,module,exports) {
'use strict';
...
},{"./Composer/Utils":"Ah8Q","./Composer/Curve":"z1Ec","./Composer/StringCurve":"NK8i","./Composer/eases":"kKuJ"}],"5xYi":[function(require,module,exports) {
'use strict';
...
var _CurveEditor = require('./CurveEditor');

var _CurveEditor2 = _interopRequireDefault(_CurveEditor);

var _StringCurveEditor = require('./StringCurveEditor');

var _StringCurveEditor2 = _interopRequireDefault(_StringCurveEditor);
...
exports.default = {
  ...
  components: {
    CurveEditor: _CurveEditor2.default,
  ...
  methods: {
    ...
    loadCurves: function loadCurves(json) {
      ...
      for (var i in json) {
        if (json[i].type === 'string') {
          this.addCurve(new _StringCurve2.default(json[i]));
        } else {
          this.addCurve(new _Curve2.default(json[i]));
        }
      }
      ...
      this.$nextTick(function () {
        if (this.$refs.curves) {
          if (Array.isArray(this.$refs.curves)) {
            this.$refs.curves.forEach(function (crv) {
              crv.updatePath();
            });
          } else {
    ...
    setRange: function setRange(start, end) {
      ...
      this.$forceUpdate();
        ...
        var $a8ed0c = exports.default || module.exports;
      
      if (typeof $a8ed0c === 'function') {
        $a8ed0c = $a8ed0c.options;
      }
...
},{"./CurveEditor":"SXj0","./StringCurveEditor":"osjH","./Composer/Curve":"z1Ec","./Composer/StringCurve":"NK8i","save-as":"5xYi"}],"1qLB":[function(require,module,exports) {
'use strict';
...
var CurveEditor = _vue2.default.extend(_App2.default);
...
},{"vue":"QPfz","./App":"Js2s","./Composer/Curve":"z1Ec","./Composer/StringCurve":"NK8i"}]},{},["1qLB"], null)