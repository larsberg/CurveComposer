...
"use strict";var n=function(){function n(n,t){for(var e=0;e<t.length;e++){var i=t[e];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}return function(t,e,i){return e&&n(t.prototype,e),i&&n(t,i),t}}(),t=require("./Utils"),e=require("./eases"),i=r(e);function r(n){return n&&n.__esModule?n:{default:n}}function o(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function")}var u=function(){function e(n){o(this,e),Object.assign(this,{name:"curve_name",points:[],currentPosition:0,currentSample:0,type:"number"},n||{})}return n(e,[{key:"sortPoints",value:function(){this.points.sort(function(n,t){return n[1]<t[1]?-1:n[1]>t[1]?1:0})}},{key:"addPoint",value:function(n,t,e){var i=[n,t,e||"smooth"];return this.points.push(i),this.sortPoints(),i}},{key:"removePoint",value:function(n){this.points.splice(n,1)}},{key:"findAndRemove",value:function(n){var t=this.points.indexOf(n);-1!==t&&this.removePoint(t)}},{key:"getPointIndex",value:function(n){return this.points.findIndex(function(t){return n===t})}},{key:"sample",value:function(n){var e=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];if(!this.points.length)return 0;var r=this.points,o=0;if(r[r.length-1][1]<=n)o=r[r.length-1][0];else if(r[0][1]>n)o=r[0][0];else{var u=r.findIndex(function(t){return t[1]>n}),s=r[r[u][1]>n?Math.max(0,u-1):u],a=r[u],f=(0,t.mapLinear)(n,s[1],a[1],0,1);o=(0,t.lerp)(s[0],a[0],i.default[s[2]](f))}return e&&(this.currentPosition=n,this.currentSample=o),o}},{key:"getMinValue",value:function(){if(!this.points.length)return 0;var n=1/0;return this.points.forEach(function(t){n=Math.min(t[0],n)}),n}},{key:"getMaxValue",value:function(){if(!this.points.length)return 1;var n=-1/0;return this.points.forEach(function(t){n=Math.max(t[0],n)}),n}}]),e}();module.exports=u;
},{"./Utils":"Ah8Q","./eases":"kKuJ"}],"SXj0":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=require("./Composer/Utils"),e=require("./Composer/Curve"),i=n(e),s=require("./Composer/eases"),a=n(s);function n(t){return t&&t.__esModule?t:{default:t}}var o=Object.keys(a.default),r=function(){return new i.default};exports.default={name:"curve",props:{w:{type:Number,default:window.innerWidth},h:{type:Number,default:100},curve:{type:Object,default:r},start:{type:Number,default:0},end:{type:Number,default:1}},data:function(){return{isShown:!0,activePoint:null,mouseDown:!1,dragged:!1,easeTypes:o,min:-1,max:1,isMouseOver:!1,mouse:{x:0,y:0},path:this.getPath(),bUpdateCrosshairs:!0}},mounted:function(){this.min=this.curve.getMinValue(),this.max=this.curve.getMaxValue(),console.log(this.start,this.end)},methods:{mapLinear:t.mapLinear,getPath:function(){for(var e=this.w,i="M",s=0,a=0;s<=e;s+=1)i+=(a=(0,t.mapLinear)(s,0,e,this.start,this.end))+" "+this.curve.sample(a,!1)+" ";return i},updatePath:function(){this.path=this.getPath()},getViewBox:function(){return this.start+" "+this.min+" "+Math.abs(this.end-this.start)+" "+Math.abs(this.max-this.min)},getTransform:function(){var t=.5*(this.max+this.min);return"matrix(1, 0, 0, -1, 0, "+(t- -1*t)+")"},onDelete:function(t){this.activePoint&&(this.curve.findAndRemove(this.activePoint),this.activePoint=null,this.updatePath())},onToggle:function(t){this.isShown=!this.isShown},onPointChange:function(t){if(this.activePoint){switch(t.target.name){case"value":var e=Number(t.target.value);this.activePoint[0]=e,this.min=Math.min(e,this.min),this.max=Math.max(e,this.max);break;case"position":this.activePoint[1]=Number(t.target.value);break;case"eases":this.activePoint[2]=t.target.value}this.curve.sortPoints(),this.updatePath()}},onRangeChange:function(t){"low"===t.target.name?this.min=Number(t.target.value):this.max=Number(t.target.value),this.$forceUpdate()},onInputFocus:function(t){this.bUpdateCrosshairs=!1},onInputBlur:function(t){this.bUpdateCrosshairs=!0},onMouseUp:function(t){this.mouseDown=!1,this.dragged=!1},onCurveTitleChange:function(t){console.log(t.target.value),this.curve.name=t.target.value},getEventPosition:function(e){var i=this.$el.querySelector("[name=workspace]").getBoundingClientRect(),s=e.offsetX,a=e.offsetY,n=(0,t.mapLinear)(s,0,i.width,this.start,this.end),o=(0,t.mapLinear)(a,0,i.height,this.max,this.min);return{x:Number(n.toFixed(4)),y:Number(o.toFixed(4))}},onMouseDown:function(t){if(this.mouseDown=!0,"line"===t.target.tagName){t.stopPropagation();var e=Number(t.target.dataset.index);this.activePoint=this.curve.points[e],this.$forceUpdate()}else this.activePoint=null},onMouseLeave:function(t){this.isMouseOver=!1},onMouseMove:function(t){this.isMouseOver=!0;var e=this.getEventPosition(t);this.mouse.x=e.x,this.mouse.y=e.y,this.mouseDown&&!t.metaKey&&(this.dragged=!0,this.onDrag(t))},onDrag:function(t){if(this.activePoint){var e=this.getEventPosition(t);this.activePoint[1]=e.x,this.activePoint[0]=e.y,this.curve.sortPoints(),this.updatePath()}},handleClick:function(t){if("svg"===t.target.tagName&&!this.dragged&&t.metaKey){var e=this.getEventPosition(t),i=this.curve.addPoint(e.y,e.x);this.activePoint=i,this.updatePath()}}}};
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this,t=e.$createElement,o=e._self._c||t;return o("div",{staticStyle:{position:"relative",width:"-300%","border-bottom":".5px solid #ffffffaa"}},[o("div",{staticStyle:{position:"relative","min-height":"20px",width:"100%",background:"#00000044"}},[o("svg",{staticStyle:{position:"absolute",right:"3",top:"3",width:"14px",height:"14px",stroke:"#fff","stroke-width":"1",fill:"#00000055"},on:{click:e.onToggle}},[o("circle",{attrs:{r:"6",cx:"7",cy:"7",stroke:"white",fill:"inherit"}}),e._v(" "),o("line",{staticStyle:{fill:"none",stroke:"#ffffff99","stroke-width":"1","vector-effect":"non-scaling-stroke"},attrs:{x1:"3",y1:"7",x2:"11",y2:"7"}}),e._v(" "),e.isShown?e._e():o("line",{staticStyle:{fill:"none",stroke:"#ffffff99","stroke-width":"1","vector-effect":"non-scaling-stroke"},attrs:{y1:"3",x1:"7",y2:"11",x2:"7"}})]),e._v(" "),e.isShown?o("div",{staticStyle:{"padding-top":"6px","min-height":"22px",border:"1px solid #ffffff44"}},[o("input",{staticStyle:{border:"none",background:"#00000000",color:"#fff"},attrs:{type:"text",name:"curveName"},domProps:{value:e.curve.name},on:{change:e.onCurveTitleChange}}),e._v(" "),o("label",{staticStyle:{color:"#a9a9a9"}},[e._v("hi:")]),e._v(" "),o("input",{staticStyle:{color:"#f0f",width:"5em","margin-right":"10px",background:"#00000099",border:"none"},attrs:{type:"number",name:"hi",step:"0.001"},domProps:{value:e.max},on:{change:e.onRangeChange,focus:e.onInputFocus,blur:e.onInputBlur}}),e._v(" "),o("label",{staticStyle:{color:"#a9a9a9"}},[e._v("low:")]),e._v(" "),o("input",{staticStyle:{color:"#f0f",width:"5em","margin-right":"10px",background:"#00000099",border:"none"},attrs:{type:"number",name:"low",step:"0.001"},domProps:{value:e.min},on:{change:e.onRangeChange,focus:e.onInputFocus,blur:e.onInputBlur}}),e._v(" "),e.activePoint?o("label",[e._v("pt:")]):e._e(),e._v(" "),e.activePoint?o("select",{staticStyle:{color:"#0ff",width:"5em","margin-right":"10px",background:"#00000099",border:"none"},attrs:{name:"eases",value:"smooth"},on:{change:e.onPointChange}},e._l(e.easeTypes,function(t){return o("option",{domProps:{value:t,selected:e.activePoint&&e.activePoint[2]===t}},[e._v(e._s(t))])}),0):e._e(),e._v(" "),e.activePoint?o("label",[e._v("u:")]):e._e(),e._v(" "),e.activePoint?o("input",{staticStyle:{color:"#0ff",width:"5em","margin-right":"10px",background:"#00000099",border:"none"},attrs:{type:"number",name:"position",step:"0.001"},domProps:{value:Number(e.activePoint[1])},on:{change:e.onPointChange,focus:e.onInputFocus,blur:e.onInputBlur}}):e._e(),e._v(" "),e.activePoint?o("label",[e._v("v:")]):e._e(),e._v(" "),e.activePoint?o("input",{staticStyle:{color:"#0ff",width:"5em","margin-right":"10px",background:"#00000099",border:"none"},attrs:{type:"number",name:"value",step:"0.001"},domProps:{value:Number(e.activePoint[0])},on:{change:e.onPointChange,focus:e.onInputFocus,blur:e.onInputBlur}}):e._e()]):o("label",{staticStyle:{"padding-top":"6px","min-height":"22px",border:"1px solid #ffffff44"}},[e._v(" "+e._s(e.curve.name)+" ")])]),e._v(" "),e.isShown?o("div",{staticStyle:{position:"relative",height:"100px",width:"100%",background:"#00000055"},attrs:{tabindex:"1",name:"workspace"},on:{keyup:function(t){return!t.type.indexOf("key")&&e._k(t.keyCode,"delete",[8,46],t.key,["Backspace","Delete","Del"])?null:e.onDelete(t)},mouseleave:e.onMouseLeave}},[o("svg",{staticStyle:{position:"absolute",left:"0",top:"0",width:"100%",height:"100%",background:"#00000044",fill:"none",stroke:"#fff","stroke-width":"1"},attrs:{viewBox:e.getViewBox(),preserveAspectRatio:"none",xmlns:"http://www.w3.org/2000/svg"},on:{mouseup:e.onMouseUp,mousedown:e.onMouseDown,mousemove:e.onMouseMove,click:e.handleClick}},[o("g",{attrs:{transform:e.getTransform()}},[e.isMouseOver?o("line",{staticStyle:{stroke:"#ffffff66",fill:"none","stroke-width":"1","vector-effect":"non-scaling-stroke","pointer-events":"none"},attrs:{x1:e.mouse.x,y1:e.min,x2:e.mouse.x,y2:e.max}}):e._e(),e._v(" "),e.isMouseOver?o("line",{staticStyle:{stroke:"#ffffff66",fill:"none","stroke-width":"1","vector-effect":"non-scaling-stroke","pointer-events":"none"},attrs:{x1:e.start,y1:e.mouse.y,x2:e.end,y2:e.mouse.y}}):e._e(),e._v(" "),e.bUpdateCrosshairs?o("line",{staticStyle:{stroke:"#99999933",fill:"none","stroke-width":"1","vector-effect":"non-scaling-stroke","pointer-events":"none"},attrs:{x1:e.curve.currentPosition,y1:e.min,x2:e.curve.currentPosition,y2:e.max}}):e._e(),e._v(" "),e.bUpdateCrosshairs?o("line",{staticStyle:{stroke:"#ffffff33",fill:"none","stroke-width":"1","vector-effect":"non-scaling-stroke","pointer-events":"none"},attrs:{x1:e.start,y1:e.curve.currentSample,x2:e.end,y2:e.curve.currentSample}}):e._e(),e._v(" "),e._l(e.curve.points,function(t,n){return o("line",{style:{"vector-effect":"non-scaling-stroke","stroke-width":"5","stroke-linecap":"round","vector-effect":"non-scaling-stroke",stroke:t===e.activePoint?"#00ffff":"#ffffffaa"},attrs:{onmouseover:"this.style.strokeWidth=7",onmouseout:"this.style.strokeWidth=5","data-index":n,x1:t[1],y1:t[0],x2:t[1],y2:t[0],fill:"red"}})}),e._v(" "),o("path",{staticStyle:{fill:"none",stroke:"#ffffff99","stroke-width":"1","vector-effect":"non-scaling-stroke","pointer-events":"none"},attrs:{d:e.path}})],2)]),e._v(" "),o("div",{staticStyle:{color:"#f0f",position:"absolute",top:"1",right:"0","font-size":".75em","user-select":"none"}},[e._v(" "+e._s(e.max)+" ")]),e._v(" "),o("div",{staticStyle:{color:"#f0f",position:"absolute",bottom:"0",right:"0","font-size":".75em","user-select":"none"}},[e._v(" "+e._s(e.min)+" ")])]):e._e()])},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"./Composer/Utils":"Ah8Q","./Composer/Curve":"z1Ec","./Composer/eases":"kKuJ"}],"NK8i":[function(require,module,exports) {
"use strict";var e=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),t=require("./Curve"),n=r(t);function r(e){return e&&e.__esModule?e:{default:e}}function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function u(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var a=function(t){function r(e){return o(this,r),i(this,(r.__proto__||Object.getPrototypeOf(r)).call(this,Object.assign({type:"string",name:"string_curve",currentSample:""},e||{})))}return u(r,n.default),e(r,[{key:"sample",value:function(e){if(this.points.length){var t,n=this.points;if(n[n.length-1][1]<=e)t=n[n.length-1][0];else if(n[0][1]>e)t=n[0][0];else{var r=n.findIndex(function(t){return t[1]>e});t=n[n[r][1]>e?Math.max(0,r-1):r][0]}return t}}}]),r}();module.exports=a;
},{"./Curve":"z1Ec"}],"osjH":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=require("./Composer/Utils"),e=require("./Composer/Curve"),i=r(e),n=require("./Composer/StringCurve"),s=r(n),o=require("./Composer/eases"),a=r(o);function r(t){return t&&t.__esModule?t:{default:t}}var u=Object.keys(a.default),h=function(){return new i.default};exports.default={name:"curve",props:{w:{type:Number,default:window.innerWidth},h:{type:Number,default:100},curve:{type:Object,default:h},textScale:{type:Number,default:1},start:{type:Number,default:0},end:{type:Number,default:1}},data:function(){return{isShown:!0,isMounted:!1,activePoint:null,mouseDown:!1,dragged:!1,easeTypes:u,min:0,max:1,isMouseOver:!1,mouse:{x:0,y:0},path:this.getPath(),bUpdateCrosshairs:!0}},mounted:function(){this.min=0,this.max=1,this.isMounted=!0},methods:{mapLinear:t.mapLinear,getPath:function(){for(var t=this.w,e="M",i=0;i<=t;i+=1)e+=i/t+" 0.5 ";return e},updatePath:function(){this.path=this.getPath()},getViewBox:function(){return this.start+" 0 "+Math.abs(this.end-this.start)+" 1"},getTransform:function(){return"matrix(1, 0, 0, -1, 0, 1)"},getTextTransform:function(t){if(this.isMounted){var e=this.$el.querySelector("[name=workspace]").getBoundingClientRect(),i=.005*this.textScale,n=(this.end-this.start)*i*e.height/e.width,s=-i;return"translate("+(t[1]+i)+", "+(1-i)+") scale("+n+","+s+") rotate(90)"}return""},onDelete:function(t){this.activePoint&&(this.curve.findAndRemove(this.activePoint),this.activePoint=null,this.updatePath())},onToggle:function(t){this.isShown=!this.isShown},onPointChange:function(t){if(this.activePoint){switch(t.target.name){case"value":var e=String(t.target.value);this.activePoint[0]=e;break;case"position":this.activePoint[1]=Number(t.target.value);break;case"eases":this.activePoint[2]=t.target.value}this.curve.sortPoints(),this.updatePath()}},onInputFocus:function(t){this.bUpdateCrosshairs=!1},onInputBlur:function(t){this.bUpdateCrosshairs=!0},onMouseUp:function(t){this.mouseDown=!1,this.dragged=!1},getEventPosition:function(e){var i=this.$el.querySelector("[name=workspace]").getBoundingClientRect(),n=e.offsetX,s=(e.offsetY,(0,t.mapLinear)(n,0,i.width,this.start,this.end));return{x:Number(s.toFixed(4)),y:Number(.5.toFixed(4))}},onMouseDown:function(t){if(this.mouseDown=!0,"line"===t.target.tagName){t.stopPropagation();var e=Number(t.target.dataset.index);this.activePoint=this.curve.points[e],this.$forceUpdate()}else this.activePoint=null},onMouseLeave:function(t){this.isMouseOver=!1},onMouseMove:function(t){this.isMouseOver=!0;var e=this.getEventPosition(t);this.mouse.x=e.x,this.mouse.y=e.y,this.mouseDown&&!t.metaKey&&(this.dragged=!0,this.onDrag(t))},onDrag:function(t){if(this.activePoint){var e=this.getEventPosition(t);this.activePoint[1]=e.x,this.curve.sortPoints(),this.updatePath()}},onCurveTitleChange:function(t){console.log(t.target.value),this.curve.name=t.target.value},handleClick:function(t){if("svg"===t.target.tagName&&!this.dragged&&t.metaKey){var e=this.getEventPosition(t),i=this.curve.addPoint("string_name",e.x);this.activePoint=i,this.updatePath()}}}};
(function(){var t=exports.default||module.exports;"function"==typeof t&&(t=t.options),Object.assign(t,{render:function(){var t=this,e=t.$createElement,o=t._self._c||e;return o("div",{staticStyle:{position:"relative",width:"-300%","border-bottom":".5px solid #ffffffaa"}},[o("div",{staticStyle:{position:"relative","min-height":"20px",width:"100%",background:"#00000044"}},[o("svg",{staticStyle:{position:"absolute",right:"3",top:"3",width:"14px",height:"14px",stroke:"#fff","stroke-width":"1",fill:"#00000055"},on:{click:t.onToggle}},[o("circle",{attrs:{r:"6",cx:"7",cy:"7",stroke:"white",fill:"inherit"}}),t._v(" "),o("line",{staticStyle:{fill:"none",stroke:"#ffffff99","stroke-width":"1","vector-effect":"non-scaling-stroke"},attrs:{x1:"3",y1:"7",x2:"11",y2:"7"}}),t._v(" "),t.isShown?t._e():o("line",{staticStyle:{fill:"none",stroke:"#ffffff99","stroke-width":"1","vector-effect":"non-scaling-stroke"},attrs:{y1:"3",x1:"7",y2:"11",x2:"7"}})]),t._v(" "),t.isShown?o("div",{staticStyle:{"padding-top":"6px","min-height":"22px",border:"1px solid #ffffff44"}},[o("input",{staticStyle:{border:"none",background:"#00000000",color:"#fff"},attrs:{type:"text",name:"curveName"},domProps:{value:t.curve.name},on:{change:t.onCurveTitleChange}}),t._v(" "),t.activePoint?o("label",[t._v("value")]):t._e(),t._v(" "),t.activePoint?o("input",{staticStyle:{color:"cyan","margin-right":"10px",background:"#00000099",border:"none"},attrs:{type:"text",name:"value"},domProps:{value:t.activePoint[0]},on:{change:t.onPointChange,focus:t.onInputFocus,blur:t.onInputBlur}}):t._e(),t._v(" "),t.activePoint?o("label",[t._v("u:")]):t._e(),t._v(" "),t.activePoint?o("input",{staticStyle:{color:"cyan",width:"5em","margin-right":"10px",background:"#00000099",border:"none"},attrs:{type:"number",name:"position",step:"0.001"},domProps:{value:Number(t.activePoint[1])},on:{change:t.onPointChange,focus:t.onInputFocus,blur:t.onInputBlur}}):t._e()]):o("label",{staticStyle:{"padding-top":"6px","min-height":"22px",border:"1px solid #ffffff44"}},[t._v(" "+t._s(t.curve.name)+" ")])]),t._v(" "),t.isShown?o("div",{staticStyle:{position:"relative",height:"100px",width:"100%",background:"#00000055"},attrs:{tabindex:"1",name:"workspace"},on:{keyup:function(e){return!e.type.indexOf("key")&&t._k(e.keyCode,"delete",[8,46],e.key,["Backspace","Delete","Del"])?null:t.onDelete(e)},mouseleave:t.onMouseLeave}},[o("svg",{staticStyle:{position:"absolute",left:"0",top:"0",width:"100%",height:"100%",background:"#00000044",fill:"none",stroke:"#fff","stroke-width":"1"},attrs:{viewBox:t.getViewBox(),preserveAspectRatio:"none",xmlns:"http://www.w3.org/2000/svg"},on:{mouseup:t.onMouseUp,mousedown:t.onMouseDown,mousemove:t.onMouseMove,click:t.handleClick}},[o("defs",[o("linearGradient",{attrs:{id:"Gradient",x1:"0",x2:"1",y1:"0",y2:"0",gradientunits:"objectBoundingBox"}},[o("stop",{attrs:{offset:"10%","stop-color":"#00000044"}}),t._v(" "),o("stop",{attrs:{offset:"95%","stop-color":"#ffffff44"}})],1)],1),t._v(" "),o("g",{attrs:{transform:t.getTransform()}},[t.curve.points.length?o("rect",{staticStyle:{"pointer-events":"none",stroke:"none",fill:"#00000044"},attrs:{x:t.start,y:"0",width:Math.max(0,t.curve.points[0][1]-this.start),height:"1"}}):t._e(),t._v(" "),t._l(t.curve.points,function(e,n){return o("g",[n<t.curve.points.length-1?o("rect",{staticStyle:{"pointer-events":"none",stroke:"none",fill:"url(#Gradient)"},attrs:{x:e[1],y:"0",width:t.curve.points[n+1][1]-e[1],height:"1"}}):o("rect",{staticStyle:{"pointer-events":"none",stroke:"none",fill:"#ffffff44"},attrs:{x:e[1],y:"0",width:t.end-e[1],height:"1"}})])}),t._v(" "),t._l(t.curve.points,function(e,n){return o("line",{style:{"vector-effect":"non-scaling-stroke","stroke-width":"3","stroke-linecap":"round","vector-effect":"non-scaling-stroke",stroke:e===t.activePoint?"cyan":"#ffffffaa"},attrs:{onmouseover:"this.style.strokeWidth=7",onmouseout:"this.style.strokeWidth=5","data-index":n,x1:e[1],y1:1,x2:e[1],y2:0,fill:"red"}})}),t._v(" "),t._l(t.curve.points,function(e,n){return o("g",{attrs:{transform:t.getTextTransform(e)}},[t.isMounted?o("text",{style:{"user-select":"none","pointer-events":"none",stroke:e===t.activePoint?"cyan":"#ffffffaa"}},[t._v(" "+t._s(e[0])+" ")]):t._e()])})],2)])]):t._e()])},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./CurveEditor"),t=f(e),r=require("./StringCurveEditor"),u=f(r),n=require("./Composer/Curve"),s=f(n),i=require("./Composer/StringCurve"),a=f(i),o=require("save-as"),d=f(o);function f(e){return e&&e.__esModule?e:{default:e}}function c(e,t){var r=new FileReader;r.addEventListener("load",function(e){var r=e.target.result;t(JSON.parse(r))},!1),r.readAsText(e)}exports.default={props:{curves:{default:function(){return[]}},title:{default:"curve composer"}},components:{CurveEditor:t.default,StringCurveEditor:u.default},data:function(){return{start:0,end:1,stringCurveTextSize:1.5}},methods:{createCurve:function(e){this.addCurve(new s.default(e))},createStringCurve:function(e){this.addCurve(new a.default(e))},addCurve:function(e){console.log("addCurve"),this.curves.push(e),this.$forceUpdate()},loadCurves:function(e){for(var t in this.curves.length=0,e)"string"===e[t].type?this.addCurve(new a.default(e[t])):this.addCurve(new s.default(e[t]));this.$nextTick(function(){this.$refs.curves&&(Array.isArray(this.$refs.curves)?this.$refs.curves.forEach(function(e){e.updatePath()}):this.$refs.updatePath())})},onLoad:function(e){c(e.target.files[0],this.loadCurves)},save:function(){var e=this.curves.map(function(e){return{name:e.name,points:e.points,type:e.type}}),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"});(0,d.default)(t,"curves.json")},setRange:function(e,t){this.start=e,this.end=t,this.$forceUpdate()}}};
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("div",{staticStyle:{"font-family":"Courier New,Courier,Lucida Sans Typewriter,Lucida Typewriter,monospace",background:"#00000099",width:"100%",height:"100%",overflow:"scroll",color:"#fff"},attrs:{id:"CurveComposer"}},[r("div",{staticStyle:{height:"24px"}},[e._v(" "+e._s(e.title)+" "),r("label",{staticStyle:{"margin-left":"10px",background:"#00000099",color:"#fff",border:"1px solid #fff","border-radius":"5px","font-size":".75em",padding:"0 4px"},attrs:{for:"saveInput"}},[e._v("save")]),e._v(" "),r("button",{attrs:{id:"saveInput",hidden:"",type:"file"},on:{click:e.save}},[e._v("save")]),e._v(" "),r("label",{staticStyle:{background:"#00000099",color:"#fff",border:"1px solid #fff","border-radius":"5px","font-size":".75em",padding:"0 4px"},attrs:{for:"loadInput"}},[e._v("load")]),e._v(" "),r("input",{attrs:{id:"loadInput",hidden:"",type:"file"},on:{change:e.onLoad}}),e._v(" "),r("label",{staticStyle:{background:"#00000099",color:"#fff",border:"1px solid #fff","border-radius":"5px","font-size":".75em",padding:"0 4px"},attrs:{for:"createCurveInput"}},[e._v("new curve")]),e._v(" "),r("button",{attrs:{id:"createCurveInput",hidden:""},on:{click:e.createCurve}}),e._v(" "),r("label",{staticStyle:{background:"#00000099",color:"#fff",border:"1px solid #fff","border-radius":"5px","font-size":".75em",padding:"0 4px"},attrs:{for:"createCurveInput"}},[e._v("new string curve")]),e._v(" "),r("button",{attrs:{id:"createCurveInput",hidden:""},on:{click:e.createStringCurve}})]),e._v(" "),e._l(e.curves,function(t){return r("div",["number"===t.type?r("CurveEditor",{ref:"curves",refInFor:!0,attrs:{curve:t,start:e.start,end:e.end}}):"string"===t.type?r("StringCurveEditor",{ref:"curves",refInFor:!0,attrs:{textscale:e.stringCurveTextSize,curve:t,start:e.start,end:e.end}}):e._e()],1)})],2)},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
...
"use strict";var e=require("vue"),r=l(e),u=require("./App"),t=l(u),o=require("./Composer/Curve"),i=l(o),n=require("./Composer/StringCurve"),d=l(n);function l(e){return e&&e.__esModule?e:{default:e}}var v=r.default.extend(t.default);function a(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"#CurveComposer";return new v({el:e})}r.default.config.productionTip=!1,module.exports={setup:a,curve:i.default,stringCurve:d.default};
